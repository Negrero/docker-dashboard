...
export namespace PluginConfigInterface {
    export type ProtocolSchemeEnum = '' | 'moby.plugins.http/v1';
    export const ProtocolSchemeEnum = {
        Empty: '' as ProtocolSchemeEnum,
        MobyPluginsHttpv1: 'moby.plugins.http/v1' as ProtocolSchemeEnum
    };
}
