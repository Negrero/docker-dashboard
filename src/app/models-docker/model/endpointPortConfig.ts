...
export namespace EndpointPortConfig {
    export type ProtocolEnum = 'tcp' | 'udp' | 'sctp';
    export const ProtocolEnum = {
        Tcp: 'tcp' as ProtocolEnum,
        Udp: 'udp' as ProtocolEnum,
        Sctp: 'sctp' as ProtocolEnum
    };
    export type PublishModeEnum = 'ingress' | 'host';
    export const PublishModeEnum = {
        Ingress: 'ingress' as PublishModeEnum,
        Host: 'host' as PublishModeEnum
    };
}
