...
export namespace SystemInfo {
    export type CgroupDriverEnum = 'cgroupfs' | 'systemd';
    export const CgroupDriverEnum = {
        Cgroupfs: 'cgroupfs' as CgroupDriverEnum,
        Systemd: 'systemd' as CgroupDriverEnum
    };
    export type IsolationEnum = 'default' | 'hyperv' | 'process';
