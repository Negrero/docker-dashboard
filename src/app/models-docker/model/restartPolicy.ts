...
export namespace RestartPolicy {
    export type NameEnum = '' | 'always' | 'unless-stopped' | 'on-failure';
    export const NameEnum = {
        Empty: '' as NameEnum,
        Always: 'always' as NameEnum,
        UnlessStopped: 'unless-stopped' as NameEnum,
        OnFailure: 'on-failure' as NameEnum
    };
}
