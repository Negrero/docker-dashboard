 ...
 */
export interface ContainerInspectResponseState { 
    /**
     * The status of the container. For example, `\"running\"` or `\"exited\"`. 
     */
    status?: ContainerInspectResponseState.StatusEnum;
    /**
...
export namespace ContainerInspectResponseState {
    export type StatusEnum = 'created' | 'running' | 'paused' | 'restarting' | 'removing' | 'exited' | 'dead';
